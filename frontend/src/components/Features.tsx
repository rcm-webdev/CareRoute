        ...
        <div className="py-20 bg-base-100">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    ADA-Compliant and patient friendly. 
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div className="text-center">
                        ...
                        <div className="bg-base-200 rounded-2xl p-8 relative z-20">
                            <h3 className="text-2xl font-chillax mb-4">Symptom Checker</h3>
                            <p className="text-base-content/70 leading-relaxed font-synonym">
                            Start with a symptom checker with just a few clicks.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="text-center">
                        ...
                        <div className="bg-base-200 rounded-2xl p-8 relative z-20">
                            ...
                            <p className="text-base-content/70 leading-relaxed font-synonym">
                            We will guide you with common questions to better understand your situation.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="text-center">
                        ...
                        <div className="bg-base-200 rounded-2xl p-8 relative z-20">
                            <h3 className="text-2xl font-chillax mb-4">Get a recommendation</h3>
                            <p className="text-base-content/70 leading-relaxed font-synonym">
                            You will then get a recommendation on whether to notify our office or follow self-care recommendations.
                            </p>
                        </div>
                    </div>
                </div>
