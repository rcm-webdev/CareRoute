            ...
            <div className="hero min-h-[calc(100vh-5rem)]">
                <div className="hero-content text-center">
                    <div className="max-w-2xl">
                        ...
                        <h1 className="text-5xl font-chillax text-gray-800">
                            "Few clicks away" from
                        </h1>
                        <h1 className="bg-primary/20 text-5xl font-chillax text-secondary px-6 py-3 rounded-2xl transform rotate-1">
                            our recommendation
                        </h1>
                        </div>
                        
                        <p className="text-lg mb-8 text-gray-600 font-synonym">
                        Click all the that apply:
                        </p>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="form-control flex flex-col items-center space-y-4">
                                        <label htmlFor="campaignGoal" className="label">
                                            <span className="label-text text-lg font-chillax">Ocular Symptoms</span>
                                        </label>
                                        <textarea
                                            id="campaignGoal"
                                            name="campaignGoal"
                                            ...
                                            placeholder="Eye redness, eye bleeding, double vision, etc"
                                            rows={4}
                                            disabled={isLoading}
                                        />
                                    </div>
                                    ...
                                    <div className="form-control">
                                        ...
                                        >
                                            {isLoading ? 'Generating...' : 'Get our recommendation'}
                                        </button>
                                    </div>
                                </form>
                            </div>
                        ...
                        {variants.length > 0 && (
                            <div className="mt-8">
                                <div className="card bg-base-100 shadow-xl">
                                    <div className="card-body">
                                        <h2 className="card-title font-chillax text-2xl mb-6 justify-center">
                                                ...
                                                <div key={index} className="card bg-base-200 shadow-sm">
                                                    <div className="card-body p-4">
                                                        <div className="flex items-start gap-3">
                                                            <div className="badge badge-primary text-primary-content badge-lg">
                                                                {index + 1}
                                                            </div>
